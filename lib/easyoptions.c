...
const struct curl_easyoption Curl_easyopts[] = {
  ...
  { "UNITY_CERTVERIFY_DATA", CURLOPT_UNITY_CERTVERIFY_DATA, CURLOT_CBPTR, 0 },
  { "UNITY_CERTVERIFY_FUNCTION", CURLOPT_UNITY_CERTVERIFY_FUNCTION,
    CURLOT_FUNCTION, 0 },
...
{
  return (CURLOPT_LASTENTRY % 10000) != (901 + 1);
}
#endif
